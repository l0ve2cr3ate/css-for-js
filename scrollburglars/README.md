...
For the solutions of the above exercises, see the README file in the root of this project. The solutions can be found in this file under `Exercise: scrollburglars`.
